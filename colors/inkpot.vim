...
hi pythonimport guifg=#915679 guibg=NONE guisp=NONE gui=NONE ctermfg=96 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#90d0f0 guibg=NONE guisp=NONE gui=NONE ctermfg=117 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#915679 guibg=NONE guisp=NONE gui=NONE ctermfg=96 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#a3a03e guibg=NONE guisp=NONE gui=NONE ctermfg=143 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#915679 guibg=NONE guisp=NONE gui=NONE ctermfg=96 ctermbg=NONE cterm=NONE
hi pythonbuiltin guifg=#966d47 guibg=NONE guisp=NONE gui=NONE ctermfg=137 ctermbg=NONE cterm=NONE
hi phpstringdouble guifg=#e6c887 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#e6c887 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE
hi javascriptstrings guifg=#e6c887 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE
hi htmlstring guifg=#e6c887 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE
hi phpstringsingle guifg=#e6c887 guibg=NONE guisp=NONE gui=NONE ctermfg=180 ctermbg=NONE cterm=NONE
hi stringdelimiter guifg=#480b67 guibg=NONE guisp=NONE gui=NONE ctermfg=53 ctermbg=NONE cterm=NONE
hi rubyregexp guifg=#85dec2 guibg=NONE guisp=NONE gui=NONE ctermfg=115 ctermbg=NONE cterm=NONE
hi string guifg=#7c27ad guibg=NONE guisp=NONE gui=NONE ctermfg=55 ctermbg=NONE cterm=NONE
hi constant guifg=#c9ccd0 guibg=NONE guisp=NONE gui=NONE ctermfg=252 ctermbg=NONE cterm=NONE
hi normal guifg=#9d77e9 guibg=#0d1510 guisp=#0d1510 gui=NONE ctermfg=141 ctermbg=233 cterm=NONE
hi rubyinstancevariable guifg=#9fff50 guibg=NONE guisp=NONE gui=NONE ctermfg=155 ctermbg=NONE cterm=NONE
hi rubyclass guifg=#9a7608 guibg=NONE guisp=NONE gui=NONE ctermfg=94 ctermbg=NONE cterm=NONE
hi identifier guifg=#92ef58 guibg=NONE guisp=NONE gui=NONE ctermfg=155 ctermbg=NONE cterm=NONE
hi comment guifg=#518964 guibg=NONE guisp=NONE gui=italic ctermfg=65 ctermbg=NONE cterm=NONE
hi rubyregexpdelimiter guifg=#3b6340 guibg=NONE guisp=NONE gui=NONE ctermfg=65 ctermbg=NONE cterm=NONE
hi rubyregexpspecial guifg=#62a48c guibg=NONE guisp=NONE gui=NONE ctermfg=72 ctermbg=NONE cterm=NONE
hi rubypredefinedidentifier guifg=#dcdfdf guibg=NONE guisp=NONE gui=NONE ctermfg=152 ctermbg=NONE cterm=NONE
hi function guifg=#1616fa guibg=NONE guisp=NONE gui=NONE ctermfg=21 ctermbg=NONE cterm=NONE
hi directory guifg=#542fdb guibg=NONE guisp=NONE gui=NONE ctermfg=20 ctermbg=NONE cterm=NONE
hi rubysymbol guifg=#d6d322 guibg=NONE guisp=NONE gui=NONE ctermfg=184 ctermbg=NONE cterm=NONE
hi rubycontrol guifg=#c7ba25 guibg=NONE guisp=NONE gui=NONE ctermfg=184 ctermbg=NONE cterm=NONE
hi rubyidentifier guifg=#9fff50 guibg=NONE guisp=NONE gui=NONE ctermfg=155 ctermbg=NONE cterm=NONE
hi condtional guifg=#ff6f27 guibg=NONE guisp=NONE gui=NONE ctermfg=202 ctermbg=NONE cterm=NONE
hi htmlitalic guifg=#7dd199 guibg=#131f17 guisp=#131f17 gui=italic ctermfg=115 ctermbg=234 cterm=NONE
hi htmlboldunderlineitalic guifg=#7dd199 guibg=#131f17 guisp=#131f17 gui=bold,italic,underline ctermfg=115 ctermbg=234 cterm=bold,underline
hi htmlbolditalic guifg=#7dd199 guibg=#131f17 guisp=#131f17 gui=bold,italic ctermfg=115 ctermbg=234 cterm=bold
hi htmlunderlineitalic guifg=#7dd199 guibg=#131f17 guisp=#131f17 gui=italic,underline ctermfg=115 ctermbg=234 cterm=underline
hi htmlbold guifg=#7dd199 guibg=#131f17 guisp=#131f17 gui=bold ctermfg=115 ctermbg=234 cterm=bold
hi htmlboldunderline guifg=#7dd199 guibg=#131f17 guisp=#131f17 gui=bold,underline ctermfg=115 ctermbg=234 cterm=bold,underline
hi htmlunderline guifg=#7dd199 guibg=#131f17 guisp=#131f17 gui=underline ctermfg=115 ctermbg=234 cterm=underline
